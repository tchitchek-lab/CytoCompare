...
# compare_categories <- function(spade1, spade2, spade1.cluster=NULL, spade2.cluster=NULL, spade1.rename=NULL, spade2.rename=NULL, markers, method="spearman", Rlim=0.8, plim=0.05, num=5, th.min_cells = 50){
  ...
  # results_1 <- SPADEVizR::importResultsFromSPADE(spade1,th.min_cells = th.min_cells)
  # results_2 <- SPADEVizR::importResultsFromSPADE(spade2,th.min_cells = th.min_cells) 
  ...
  # mat1 <- SPADEVizR:::computePhenoTable(results_1@cluster.phenotypes, bounds = results_1@bounds, num = num)
  # mat2 <- SPADEVizR:::computePhenoTable(results_2@cluster.phenotypes, bounds = results_2@bounds, num = num)
